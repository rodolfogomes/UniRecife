...
public class FormAluno extends javax.swing.JDialog {
    ...
    FachadaAluno fachada = new FachadaAluno();

    public void atualizaTabelaAluno() throws DAOException {
        listaAluno.clear();
        try {
            listaAluno.addAll(fachada.listar());
            int linha = listaAluno.size()-1 ;
            if (linha >= 0) {
                tblAluno.setRowSelectionInterval(linha, linha);
                tblAluno.scrollRectToVisible(
                        tblAluno.getCellRect(linha, linha, true)
                );
            }
     ...
     private void isEditar(boolean editando){
         ...
         tblAluno.setEnabled(!editando);
     }

  
    public FormAluno(java.awt.Frame parent, boolean modal) throws DAOException {
        super(parent, modal);
        initComponents();
        atualizaTabelaAluno();
        isEditar(false);
    ...
    private void initComponents() {
        ...
        listaAluno = org.jdesktop.observablecollections.ObservableCollections.observableList(new ArrayList<Aluno>())
        ;
        ...
        org.jdesktop.swingbinding.JTableBinding jTableBinding = org.jdesktop.swingbinding.SwingBindings.createJTableBinding(org.jdesktop.beansbinding.AutoBinding.UpdateStrategy.READ_WRITE, listaAluno, eLProperty, tblAluno);
        ...
        org.jdesktop.beansbinding.Binding binding = org.jdesktop.beansbinding.Bindings.createAutoBinding(org.jdesktop.beansbinding.AutoBinding.UpdateStrategy.READ_WRITE, tblAluno, org.jdesktop.beansbinding.ELProperty.create("${selectedElement.codigo}"), txtId, org.jdesktop.beansbinding.BeanProperty.create("text"));
        bindingGroup.addBinding(binding);

        jLabel1.setText("Descricao:");

        binding = org.jdesktop.beansbinding.Bindings.createAutoBinding(org.jdesktop.beansbinding.AutoBinding.UpdateStrategy.READ_WRITE, tblAluno, org.jdesktop.beansbinding.ELProperty.create("${selectedElement.descricao}"), txtDescricao, org.jdesktop.beansbinding.BeanProperty.create("text"));
        bindingGroup.addBinding(binding);
    ...
    private void btnsalvarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnsalvarActionPerformed
        try {
            ...
            Aluno aluno = listaAluno.get(linhaSelecionada);
    ...
    private void btnNovoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnNovoActionPerformed
        listaAluno.add((Aluno) new Aluno());
        int linha = listaAluno.size()-1;
        tblAluno.setRowSelectionInterval(linha, linha);
        isEditar(true);
    ...
    private void btnPrimeiroActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnPrimeiroActionPerformed
        ...
        tblAluno.scrollRectToVisible(tblAluno.getCellRect(0, 0, true));
    ...
    private void btnAnteriorActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAnteriorActionPerformed
        ...
        tblAluno.setRowSelectionInterval(linha, linha);
        tblAluno.scrollRectToVisible(tblAluno.getCellRect(linha, 0, true));
    }//GEN-LAST:event_btnAnteriorActionPerformed

    private void btnProximoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnProximoActionPerformed
        int linha = tblAluno.getSelectedRow();
        if((linha + 1) <= (tblAluno.getRowCount() -1)){
            linha++;
    ...
    private void btnUltimoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnUltimoActionPerformed
        int linha = tblAluno.getRowCount() -1;
        tblAluno.setRowSelectionInterval(linha, linha);
        tblAluno.scrollRectToVisible(tblAluno.getCellRect(linha, linha, true));
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                FormAluno dialog = null;
                try {
                    dialog = new FormAluno(new javax.swing.JFrame(),true);
                } catch (DAOException ex) {
                    Logger.getLogger(FormAluno.class.getName()).log(Level.SEVERE, null, ex);
                }
    ...
    private java.util.List<Aluno> listaAluno;
